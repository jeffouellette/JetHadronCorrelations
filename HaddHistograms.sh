...
declare -a datavardirs=("Nominal" "HITightVar" "HILooseVar" "TrkEffVar" "FakeRateVar" "PrimFitVar" "JetPrimFracVar" "PartSpcVar" "MixCatVar1" "MixCatVar3" "MixCatVar5")
#declare -a datavardirs=("JetPrimFracVar")


declare -a mcvardirs=("Nominal")
#declare -a mcvardirs=("Nominal" "JESVar0" "JESVar1" "JESVar2" "JESVar3" "JESVar4" "JESVar5" "JESVar6" "JESVar7" "JESVar8" "JESVar9" "JESVar10" "JESVar11" "JESVar12" "JESVar13" "JESVar14" "JESVar15" "JESVar16" "JESVar17" "JESVar18" "JESVar19" "JESVar20") # don't run JESVar14 or JESVar20, they are not applicable
#declare -a mcvardirs=("Nominal" "JESVar0" "JESVar1" "JESVar2" "JESVar3" "JESVar4" "JESVar5" "JESVar6" "JESVar7" "JESVar8" "JESVar9" "JESVar10" "JESVar11" "JESVar12" "JESVar13" "JESVar15" "JESVar16" "JESVar17" "JESVar18" "JESVar19")
...
declare -a ppRuns=(340644 340683 340697 340718 340814 340849 340850 340910 340925 340973 341027 341123 341184)
...
for sigmix in ${sigmixdirs[@]}; do
  ...
  for vardir in ${datavardirs[@]}; do
    ...
    for ppRun in ${ppRuns[@]}; do 
      hadd -f -j 4 ${targetPath}/${ppRun}_hists.root \
                   ${j50Path}/${ppRun}*hists.root \
                   ${mbPath}/${ppRun}*hists.root
    done

    hadd -f -j 4 ${targetPath}/data17_5TeV_hists.root \
                 ${targetPath}/340644_hists.root \
                 ${targetPath}/340683_hists.root \
                 ${targetPath}/340697_hists.root \
                 ${targetPath}/340718_hists.root \
                 ${targetPath}/340814_hists.root \
                 ${targetPath}/340849_hists.root \
                 ${targetPath}/340850_hists.root \
                 ${targetPath}/340910_hists.root \
                 ${targetPath}/340925_hists.root \
                 ${targetPath}/340973_hists.root \
                 ${targetPath}/341027_hists.root \
                 ${targetPath}/341123_hists.root \
                 ${targetPath}/341184_hists.root
...
#            ${mcPath}/pPb16_JZ0*iCent${cent}_hists.root \
