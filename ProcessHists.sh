...
root -l -b -q 'src/ProcessPtCh.C("60GeVJets", "60GeVJets")'
root -l -b -q 'src/ProcessPtCh.C("30GeVJets", "30GeVJets")'
#root -l -b -q 'src/ProcessPtCh.C("15GeVJets", "15GeVJets")'
...
#root -l -b -q 'src/ProcessDPhi.C("60GeVJets", "60GeVJets")'
#root -l -b -q 'src/ProcessDPhi.C("30GeVJets", "30GeVJets")'
#root -l -b -q 'src/ProcessDPhi.C("15GeVJets", "15GeVJets")'
...
#root -l -b -q 'src/PlotDPhi.C("15GeVJets", "15GeVJets")'
...
#root -l -b -q 'src/CalculateIAAShifts.C("15GeVJets", "15GeVJets")'

root -l -b -q 'src/PlotPtCh.C("60GeVJets", "60GeVJets")'
root -l -b -q 'src/PlotPtCh.C("30GeVJets", "30GeVJets")'
#root -l -b -q 'src/PlotPtCh.C("15GeVJets", "15GeVJets")'
